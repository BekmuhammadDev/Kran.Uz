          ...
          <div>
            <div className="flex justify-between">
              ...
              <div className="justify-center items-center z-10">
                <h1 className="text-white text-[40px] font-normal text-center">
                  Avtovishka Daewoo
                </h1>
                <h1 className="text-white text-[32px] font-normal text-center">
                  Novus
                </h1>
              </div>

              <div>
                <p className="text-white text-base font-medium text-left">
                  Website orqali buyurtma qoldiring <br /> va o‘zingizga qulay
                  avtovishkani <br /> ijaraga oling. Qiziqtirgan savollar <br />{" "}
                  uchun murojat yuboring yoki <br /> telefon qiling. Qiziqtirgan
                  savollar <br /> uchun murojat yuboring yoki <br /> telefon
                  qiling.
                </p>
              </div>
            </div>
